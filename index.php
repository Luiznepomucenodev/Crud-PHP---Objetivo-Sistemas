    ...
    <main>
        ...
        <div class="row py-lg-5">
            <div class="col-lg-7 mx-auto">
                ...
                <form method="post" action="data/conexao.php">

                <div class="mb-3">
                    <label for="" class="form-label">Nome:</label>
                    <input type="text" name="nome" class="form-control" id="" placeholder="Fulano da Silva Santos">
                </div>
                <div class="mb-3">
                    <label for="" class="form-label">Telefone:</label>
                    <input type="number" name="numero" class="form-control" id="" placeholder="(71) 3241-3010">
                </div>
                <div class="mb-3">
                    <label for="" class="form-label">Observação:</label>
                    <textarea name="obs" class="form-control" id="" placeholder="Alguma Observação Aqui !" rows="3"></textarea>
                </div>
